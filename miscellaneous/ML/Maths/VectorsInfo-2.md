...
3
​    
 ), and a distance to a school (x 
4
​    
 ). Instead of creating complex 4D algebraic equations, we just put all those inputs into a single array: X = [x1, x2, x3, x4]. This is a 4-dimensional vector.
