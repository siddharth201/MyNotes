...
### KEY POINTS
> ML learns from **history and patterns** — not rules written by hand.</br></br>
**Bank loan example:** C1 earns more BUT has fraud history → the **pattern in past data** changes the decision completely.</br></br>
