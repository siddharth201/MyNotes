...
````math
x = \begin{bmatrix} 32 \\ 85000 \\ 760 \\ 84 \end{bmatrix}
````
...
$$\mathbf{x}=\begin{bmatrix}2&5&8\end{bmatrix}$$
...
````math
x = \begin{bmatrix} 5 \\ 8 \end{bmatrix}
````
...
````math
x = \begin{bmatrix} 2 \\ 7 \\ 3 \\ 1 \\ 5 \end{bmatrix}
````
Dimension = 5
...
````math
x = \begin{bmatrix} 1800 \\ 3 \\ 2 \\ 5 \end{bmatrix}
````
